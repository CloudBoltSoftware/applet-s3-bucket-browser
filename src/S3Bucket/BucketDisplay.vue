  ...
  <div class="d-flex flex-column">
    ...
    <div class="d-flex justify-space-between">
      <VBtnGroup>
        ...
        <UploadModal />
        <CreateModal />
        <VBtn v-if="isFlat" icon="mdi-folder-eye" title="Toggle Folder View" size="x-large" @click="getFlattenedView"/>
        <VBtn v-else icon="mdi-view-headline"  title="Toggle Flat List View" size="x-large" @click="getFlattenedView" />
      </VBtnGroup>
...
const { getFlattenedView, isFlat, bucketResource, bucketState } = useBuckets(api)
const { dropZoneRef, onDrop, dropModal, dropError, clearModal, clearError } = useDrop(api)
