    ...
    try:
        ...
        if s3_bucket["Status"] == "Enabled":
            ...
            for version in versions:
                ...
                download_url = operations.create_presigned_url(
                    bucket_name, object_name, aws, version_id=version_id
                )
                json_data = {
                    ...
                    "last_modified": version.get("LastModified").strftime(
                        "%B %d, %Y, %I:%M %p"
                    ),
            ...
            for marker in delete_markers:
                json_data = {
                    ...
                    "last_modified": marker.get("LastModified").strftime(
                        "%B %d, %Y, %I:%M %p"
                    ),
